...
public class LoggerKit {
    ...
    public static final String X_REQUEST_DATA = "X-REQUEST-DATA";
    ...
    public static void pushRID(String rid) {
        MDC.put("X-RID", StringUtil.isEmpty(rid) ? UUID.randomUUID().toString() : rid);
    }

    public static void pushRequestData(String dataStr) {
        MDC.put("X-REQUEST-DATA", dataStr);
    }

    public static String getRequestData() {
        String result = MDC.get("X-REQUEST-DATA");
